...
//            $(".filter").not('.filter[filter-item="'+value+'"]').addClass('hidden');
    ...
    if($('.progress-bar-layout-1').length) {
        
        $('.progress-bar-layout-1').find('.progress-bar').each(function(){
            ...
            if ($this.attr('data-bar-width') && !isNaN($this.data('bar-width'))) {

                width = $this.data('bar-width');
            ...
            if ( $this.attr('data-bar-icon') ) {

                icon = 'progress-icon ' + $this.data('bar-icon');
            ...
            $this.find('.progress-icon').css({
                'color' : color,
                'border-color' : color
            }).removeAttr("class").addClass(icon);
    ...
    if ($('.progress-bar-layout-2').length) {

        $('.progress-bar-layout-2').find('.progress-bar').each(function () {
